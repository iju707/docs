import{_ as o,r as t,o as i,c as l,a,b as n,d as s,e as d}from"./app-95e21c4a.js";const r={},p={href:"https://dart.dev/language/comments",target:"_blank",rel:"noopener noreferrer"},m=d(`<p>Dart는 한줄 주석, 여러줄 주석, 문서화 주석을 지원합니다.</p><h2 id="single-line-comments" tabindex="-1"><a class="header-anchor" href="#single-line-comments" aria-hidden="true">#</a> 한줄 주석</h2><p>한줄 주석은 <code>//</code>로 시작합니다.<br><code>//</code>와 해당 줄 끝까지 모든것은 Dart 컴파일러가 무시합니다.</p><div class="language-dart line-numbers-mode" data-ext="dart"><pre class="language-dart"><code><span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">Llama</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>클래스의 생성된 문서에서 <code>[feed]</code>는 <code>feed</code> 메소드의 문서로 링크가 되며, <code>[Food]</code>는 <code>Food</code> 클래스의 문서로 링크됩니다.</p>`,13),u={href:"https://dart.dev/tools/dart-doc",target:"_blank",rel:"noopener noreferrer"},v=a("code",null,"dart doc",-1),k=a("br",null,null,-1),b={href:"https://api.dart.dev/stable",target:"_blank",rel:"noopener noreferrer"},h=a("br",null,null,-1),f={href:"https://dart.dev/guides/language/effective-dart/documentation",target:"_blank",rel:"noopener noreferrer"};function _(g,y){const e=t("ExternalLinkIcon"),c=t("AdsenseB");return i(),l("div",null,[a("p",null,[n("원문 : "),a("a",p,[n("https://dart.dev/language/comments"),s(e)])]),m,a("p",null,[n("Dart 코드를 분석하고 HTML 문서를 생성하기 위해 "),a("a",u,[v,s(e)]),n("이라는 Dart의 문서 생성도구를 사용해야 합니다."),k,n(" 생성된 문서에 대한 예제는 "),a("a",b,[n("Dart API 문서"),s(e)]),n("를 참고하세요."),h,n(" 주석을 구조화하는 방법에 대한 조언은 "),a("a",f,[n("효과적인 Dart: 문서"),s(e)]),n("를 참조하세요.")]),s(c)])}const L=o(r,[["render",_],["__file","comments.html.vue"]]);export{L as default};
